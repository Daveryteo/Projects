...
class Creature:
    ...
    def __init__(self, gene_count):
        self.spec = g.Genome.get_gene_spec()
        self.dna = g.Genome.get_random_genome(len(self.spec), gene_count)
    ...
    def get_flat_links(self):
        gdicts = g.Genome.get_genome_dicts(self.dna, self.spec)
        self.flat_links = g.Genome.genome_to_links(gdicts)
    ...
    def get_expanded_links(self):
        ...
        g.Genome.expandLinks(self.flat_links[0], self.flat_links[0].name, self.flat_links, exp_links)
        self.exp_links = exp_links
        return self.exp_links

    def to_xml(self):
        assert(self.exp_links != None), "creature: call get exp_links before to_xml"
        self.get_expanded_links()
    ...
    def get_motors(self):
        assert (self.exp_links != None), "creature: call get exp_links before get_motors"
        if self.motors == None:
            motors = []
